...
const Author = () => {
  ...
  return (
    <Card interactive={true}>
        <h3>Author Info</h3>
        <FormGroup label="Id" labelFor="id-input">
            <InputGroup id="id-input" placeholder="Author id" value={author.id} readonly />
        </FormGroup>
        <FormGroup label="Firstname" labelFor="firstname-input">
            ...
            onChange={(event) => {setAuthor(prevAuthor => {
                ...
                newAuthor.firstname = event.target.value;
                return newAuthor;
            });}} />
        </FormGroup>
        <FormGroup label="Lastname" labelFor="lastname-input">
            ...
            onChange={(event) => {setAuthor(prevAuthor => {
                const newAuthor = {...prevAuthor};
                newAuthor.lastname = event.target.value;
                return newAuthor;
            });}} />
        </FormGroup>
