...
public class SubscribeTicketsInfoQueryHandler implements CallbackQueryHandler {
  ...
  @Autowired
  public SubscribeTicketsInfoQueryHandler(FlightSubscriptionService subscribeService,
  ...
  public SendMessage handleCallbackQuery(CallbackQuery callbackQuery) {
    ...
    if (userSubscriptionOptional.isEmpty()) {
      return messagesService.getWarningReplyMessage(chatId, "Запрос устарел, чтобы подписаться, повторите поиск.");
    }
